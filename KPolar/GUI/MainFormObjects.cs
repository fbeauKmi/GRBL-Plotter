...
namespace GrblPlotter
{
    ...
    public static class GuiVariables
    {
        ...
        {
            const string reg_key0 = "HKEY_CURRENT_USER\\SOFTWARE\\KPolar";
            const string reg_key = "HKEY_CURRENT_USER\\SOFTWARE\\KPolar\\Dimension";
            try
            {
        ...
        {
            const string reg_key0 = "HKEY_CURRENT_USER\\SOFTWARE\\KPolar";
            const string reg_key = "HKEY_CURRENT_USER\\SOFTWARE\\KPolar\\GCodeSettings";
            try
            {
        ...
        {
            //            const string reg_key0 = "HKEY_CURRENT_USER\\SOFTWARE\\KPolar";
            const string reg_key = "HKEY_CURRENT_USER\\SOFTWARE\\KPolar\\Position";
            try
            {
