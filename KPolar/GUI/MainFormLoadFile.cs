...
namespace GrblPlotter
{
    public partial class MainForm : Form
    {
        ...
        private const string loadFilter = "SVG - Scalable Vector Graphics|*.svg|" +
        ...
        private bool LoadFile(string fileName)
        {
            ...
            if (!string.IsNullOrEmpty(serverIP.Text)){ btnExpGcode.Enabled = true; }
        ...
        private void BtnSaveFile_Click(object sender, EventArgs e)
        {
            ...
            SaveFileDialog sfd = new SaveFileDialog
            {
                ...
                FileName = saveName + "_",
                Filter = "GCode (*.gcode)|*.gcode|All files (*.*)|*.*"   // "GCode|*.gcode";
            };
        ...
        private void SaveMachineParametersToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                SaveFileDialog sfd = new SaveFileDialog
                {
                    ...
                    FileName = "Kpolar_" + DateTime.Now.ToString("yyyyMMdd_HHmmss") + ".ini"
                };
                if (sfd.ShowDialog() == DialogResult.OK)
                {
        ...
        {
            openFileDialog1.FileName = "KPolar.ini";
        ...
        private void EnglishToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Restart of Kpolar is needed", "Attention");
            TryRestart();
        }
        private void DeutschToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Properties.Settings.Default.guiLanguage = "de-DE";
            MessageBox.Show("Ein Neustart von Kpolar ist erforderlich", "Achtung");
            TryRestart();
        }
        private void RussianToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Properties.Settings.Default.guiLanguage = "ru";
            MessageBox.Show("Необходим перезапуск KPolar.\r\n" +
        ...
        private void FranzToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Un redémarrage de KPolarr est nécessaire.\r\n" +
        ...
        {
            if (hotkey.TryGetValue(keyData, out string action)) // Returns true.
            {
